        ...
        <div onLoad={Remover}>
            ...
            <div id="Corpo-Skills">
                <div id="areaTextoSkills">
                    ...
                    <ol id="IpmaiaTexto">
                        <li>
                            <p>Currently studying <span>Information Technology, Web and Multimedia</span> at IpMaia!</p>
                            <br />
                            <a href="https://www.ipmaia.pt/pt/ensino/oferta-formativa/licenciaturas/tecnologias-informacao-web-multimedia" target="_blank"  id="LogoIpmaia" ><img src={IpMaiaLogo}/></a>
                            <p id="textoDevTheDevs">Certificate obtained:<br />
                                ...
                                <a href="https://drive.google.com/file/d/19Fvh6rw7xp9Kk3QX6_1Uu6Er_JoAd7r5/view" target="_blank" id="LogoPucrsDEV"><object data={LogoDEVs} id="LogoPucrsDEVsvg"></object></a>
                            </p>
